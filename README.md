...
>How do I use it?
  ...
  3. Check if the path to the folder you used to unzip your data doesn't contain non-latin symbols, since the script will crash if the path at any point does contain them.
  4. This means if your path looks loke that "C:\Users\Иван\Documents\Img\North\2022" -- script will complain about path unintegrity (with a flashing messages in cmd) and terminate itself, so use instead something like "C:\Users\Ivan\Documents\Img\North\2022"
  ...
  6. Then you will be asked which background image script should use -- click "North" if your images are for nothern hemisphere and "South" is, respectively, for southern. WARNING: incorrect background image will create massive deviation in calculated data.
...
> Как мне его использовать?
  ...
  5. Поэтому лучше иметь путь такого рода: "C:\Users\Ivan\Documents\Img\North\2022"
